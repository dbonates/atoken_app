...
<ul>
	<li>u = User.create(:username => 'admin', :email => 'admin@dbo.com', :assinante => true)<br>
	u.password = 'secret'<br>
	u.save<br></li>
	<li/>
	<li>u = User.create(:username => 'admin2', :email => 'admin2@dbo.com', :assinante => false)<br>
	<li>u.password = 'secret'<br>
	<li>u.save 
	<li/>
	<li>u = User.create(:username => 'admin3', :email => 'admin3@dbo.com', :assinante => true)<br>
	<li>u.password = 'secret'<br>
	<li>u.save<br>
<ul>
